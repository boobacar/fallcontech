...
export const articleSeo = {
  ...
  "/article/agence-web-dakar-comment-choisir-2026": ["Agence web à Dakar : comment choisir en 2026", "Checklist concrète pour choisir le bon partenaire web à Dakar : méthode, livrables, budget et erreurs à éviter."],
  "/article/prix-creation-site-web-senegal-guide-complet": ["Prix création site web au Sénégal : guide complet", "Comprendre les prix d’un site vitrine, e-commerce ou site business au Sénégal et les facteurs qui font varier le budget."],
  ...
  "/article/comment-choisir-developpeur-web-dakar-senegal": ["Comment choisir un développeur web à Dakar ?", "Freelance ou agence, junior ou senior : choisir le bon prestataire pour créer votre site web."],
