...
const pages = {
  web: {
    ...
    seoTitle: "Web Development Company Senegal | Custom Websites & Web Apps Dakar",
    seoDescription:
  ...
  mobile: {
    ...
    seoTitle: "Mobile App Development Senegal | Android & iOS Apps Dakar",
  ...
  software: {
    ...
    seoTitle: "Software Development Senegal | Custom Business Apps Dakar",
