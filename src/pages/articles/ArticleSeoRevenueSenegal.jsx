  ...
  return (
    <>
      ...
      <article className="py-16 bg-background"><div className="container mx-auto px-4 max-w-3xl prose prose-lg">
        ...
        <p>
          Envie de dominer les résultats de recherche dans votre secteur d'activité ? Confiez votre stratégie à une <Link to="/services/agence-seo-senegal">agence SEO à Dakar</Link>, faites le point avec un <Link to="/services/audit-seo-professionnel-senegal">audit SEO professionnel</Link> ou partez d'une base saine avec notre <Link to="/services/creation-site-web-dakar">création de site web à Dakar</Link>.
        </p>
